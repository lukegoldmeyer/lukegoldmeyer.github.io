...
- Copy the whole `formatting/` folder, rename it, strip the parts you don't
  want, and you've got a styled starter. The live URL is `/projects/` plus the
  folder name (e.g. `/projects/formatting/`).
